...
<html lang="id"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Manajemen Produk PT RAL</title>
  <script src="./Manajemen Produk PT RAL_files/saved_resource"></script>
  <style>
    .editable {
      cursor: pointer;
      padding: 4px;
...
<body class="bg-gray-100 min-h-screen flex flex-col">
        ...
        <tbody>
          <tr>
            ...
            <td class="border px-3 py-2">
              <input type="number" value="1000" class="w-1/2 bg-transparent outline-none inline-block">
  ...
  <script>
    ...
    function simpanData(idTabel, tipe) {
